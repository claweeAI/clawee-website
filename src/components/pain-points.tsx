...
export function PainPoints() {
  return (
    <section id="pain-points" className="bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {PAIN_POINTS.map((p) => (
            <div
              key={p.title}
              className="group rounded-xl border border-border bg-surface-muted p-5 transition-all hover:border-primary/30 hover:bg-white hover:shadow-md sm:p-6"
            >
