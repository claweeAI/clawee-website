  ...
  return (
    <section id="contact" className="bg-surface-muted py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-3 rounded-2xl bg-primary px-8 py-4 text-lg font-bold text-surface shadow-lg shadow-primary/25 transition-all hover:bg-primary-dark hover:shadow-xl hover:shadow-primary/30 sm:w-auto sm:px-14 sm:py-5 sm:text-xl"
            >
        ...
        <div className="mx-auto mt-16 max-w-3xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-4">
            {CONSULTATION_STEPS.map((step) => (
              <div key={step.step} className="relative rounded-xl border border-border bg-surface-card p-5 text-center">
                {/* 步驟編號 */}
                <div className="mx-auto mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-primary text-sm font-bold text-surface">
                  {step.step}
                </div>
        ...
        {/* 保證 */}
        <div className="mx-auto mt-12 max-w-lg rounded-2xl border border-border bg-surface-card p-6 text-center">
